...
export class QueryClient implements Query {
...
export class StatementClient implements Statement {
    constructor(x: any) {
    }
}
...
export class Db<T> implements Dbms {
    ...
    async begin(): Promise<Tx> {
        return new TxClient(this.ask('begin'))
    }
